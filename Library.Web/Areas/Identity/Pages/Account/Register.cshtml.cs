...
namespace Library.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(StaticData.LibrarianRole).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(StaticData.LibrarianRole)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(StaticData.MemberRole)).GetAwaiter().GetResult();
            }
